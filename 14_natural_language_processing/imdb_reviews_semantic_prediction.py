...
print("Negative:")
top_negative_phrases_indices = np.argsort(logistic_model.coef_[0])[:top_phrase_count]
top_negative_phrases = [tfidf_features_names[z] for z in top_negative_phrases_indices]
print(top_negative_phrases)

print("Positive:")
top_positive_phrases_indices = np.argsort(logistic_model.coef_[0])[-top_phrase_count:]
top_positive_phrases = [tfidf_features_names[z] for z in top_positive_phrases_indices]

...
conversion_df.drop(columns=["birthday", "age"], inplace=True)
...
conversion_df = conversion_df.astype(
    {"ad effectiveness": "int64"})

colors_grouped = (
    conversion_df[["color scheme", "followed ad", "made purchase"]].groupby("color scheme")).mean()
